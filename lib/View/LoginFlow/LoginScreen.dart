...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> loginCall(TextEditingValue valueEmail, TextEditingValue valuePass) async  {
    ...
    final response = await http.post(Uri.parse(ApiEndPoints.login),headers:{"Content-Type": "application/json"},body: body,);
